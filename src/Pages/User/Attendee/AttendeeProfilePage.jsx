...
const AttendeeProfilePage = () => {
  ...
  useEffect(() => {
    ...
    const fetchProfilePicture = async () => {
      try {
        const blob = await attendeeProfileService.getProfilePicture();
  ...
  const handleUpdateProfile = async (data) => {
    try {
      const response = await attendeeProfileService.updateProfile(data);
      toast.success(response.message);
      setEditMode(false);
      const profileData = await attendeeProfileService.getProfile();
  ...
  const uploadProfilePicture = async () => {
    ...
    try {
      setIsUploading(true);
      const response = await attendeeProfileService.uploadProfilePicture(profilePictureFile);
      toast.success(response.message);
      const profileData = await attendeeProfileService.getProfile();
      setUserData(profileData);
      const blob = await attendeeProfileService.getProfilePicture();
  ...
  const deleteProfilePicture = async () => {
    try {
      const response = await attendeeProfileService.deleteProfilePicture();
      toast.success(response.message);
        ...
        <div className="bg-white shadow-2xl rounded-2xl overflow-hidden">
          ...
          <div className="relative">
            ...
            <div className="absolute top-1/2 right-8 transform -translate-y-1/2 text-right">
              ...
              <p className="text-indigo-100">{userData.email || userData.phone}</p>
            </div>
                            ...
                            <motion.button
                              ...
                              onClick={() => {
                                ...
                                if (userData.hasProfilePicture) {
                                  setProfilePicture(URL.createObjectURL(attendeeProfileService.getProfilePicture()));
                                } else {
                                  setProfilePicture(null);
                                }
                              }}
