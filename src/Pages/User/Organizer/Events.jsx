  ...
  return (
    ...
    >
                        ...
                        >
                          ...
                          {event.status?.toLowerCase() === "published" && (
                            <Button
                              ...
                              startIcon={<FiShare2 />}
                              onClick={() => {
                                setShareLink(`${window.location.origin}/events/${event.id}`)
                                setQrModalOpen(true)
                              }}
                              sx={{
                                textTransform: "none",
          ...
          <Typography>
            {selectedEvents.length > 1
              ...
              : `Are you sure you want to delete "${
                  selectedEvent?.title || (events.find((e) => e.id === selectedEvents[0])?.title ?? "this event")
      ...
      >
        ...
        <MenuItem
          onClick={() => {
            setShareLink(`${window.location.origin}/events/${selectedEvent.id}`)
            setQrModalOpen(true)
            handleMenuClose()
          }}
          sx={{ padding: "8px 16px" }}
